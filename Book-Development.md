...
1. **Language Processing and the Natural Language Toolkit**
    ...
    2. Sub-tasks: WSD, pronoun resolution, entailment, finding things in text, language modeling, collocations, sentence segmentation, lexicon(?), normalization (stemming, unicode, case), syntax -- (identify tasks and writers by mid June)
